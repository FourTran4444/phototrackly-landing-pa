...
export async function POST(request: NextRequest) {
  try {
    ...
    // These headers must come from the trusted hosting proxy. Only an HMAC is persisted.
    ...
    // No form values, tokens, IPs, or database error payloads in logs.
    console.error('[early-access] Storage operation failed');
